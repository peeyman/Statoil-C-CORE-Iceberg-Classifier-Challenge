...
def getVggAngleModel():
    ...
    cnn = Conv2D(64,kernel_size=(11, 11),activation='relu')(cnn)
    ...
    cnn = BatchNormalization()(cnn)
    cnn = AveragePooling2D(pool_size=(2, 2), strides=(2, 2))(cnn)
    cnn = Dropout(0.2)(cnn)
    ...
    # #Conv Layer 5
    # cnn = Conv2D(512, kernel_size=(3, 3), activation='relu')(cnn)
    # cnn = MaxPooling2D(pool_size=(2, 2), strides=(2, 2))(cnn)
    # cnn = Dropout(0.7)(cnn)
...
valid_pred_df.to_csv('../Preds/valid.peyman.cnn.size.v1.csv',index=False)
#Submission for each day.
submission = pd.DataFrame()
submission['id']=test['id']
submission['is_iceberg']=test_preds
submission.to_csv('../Preds/sub.peyman.cnn.size.v1.csv', index=False)
